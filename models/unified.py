...
Pydantic implementation for the GFG (FastAPI) service. The wire format is
identical across all six services. GeeksforGeeks exposes no contest, rating or
badge data publicly, so those sections are always empty/``null``.
"""
