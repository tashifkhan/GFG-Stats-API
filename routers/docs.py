...
# Use a new router name for clarity
...
docs_html_content = """
    ...
    <body>
        ...
        <p>Analyze GeeksForGeeks user statistics interactively below. Enter a username to view their stats, profile, and solved problems.</p>
        <div class="stalker-form" style="margin-bottom: 2.5rem;">
            <h3>Explore a GeeksForGeeks Profile</h3>
            <div class="input-group">
                <input type="text" id="gfg-username" placeholder="Enter GFG username (e.g., khantashif)" />
                <button onclick="stalkGFGUser()" class="stalk-button">Analyze Profile</button>
            </div>
...
@docs_router.get("/", summary="API Documentation", response_class=HTMLResponse)
async def root():
    """
...
@docs_router.get("/api-docs", summary="API Documentation")
async def api_docs():
