...
ACCENT = '#2f8d46'
DESCRIPTION = 'Fundamentals analytics for GeeksForGeeks profiles, solved-problem breakdowns, and activity heatmaps.'
PARAM = 'username'
...
CANONICAL_ENDPOINTS = [
    ...
    ('GET', '/{username}/heatmap', 'Solved-problem heatmap'),
    ('GET', '/{username}/badges', 'Empty badges'),
]
LEGACY_ENDPOINTS = [
    ('GET', '/{username}/solved-problems', 'Deprecated solved-problem details'),
]
